...
class ModelStarmoozieCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'starmoozie:model';
     ...
     * @var string
     */
    protected $signature = 'starmoozie:model {name} {--softdelete}';
     ...
     * @var string
     */
    protected $description = 'Generate a starmoozie templated model';
