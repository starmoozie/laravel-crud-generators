...
class CrudModelStarmoozieCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'starmoozie:crud-model';
     ...
     * @var string
     */
    protected $signature = 'starmoozie:crud-model {name}';
     ...
     * @var string
     */
    protected $description = 'Generate a Starmoozie CRUD model';
     ...
     * @var string
     */
    protected $crudTrait = 'Starmoozie\CRUD\app\Models\Traits\CrudTrait';
