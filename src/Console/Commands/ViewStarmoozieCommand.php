...
class ViewStarmoozieCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'starmoozie:view';
     ...
     * @var string
     */
    protected $signature = 'starmoozie:view {name} {--plain}';
     ...
     * @var string
     */
    protected $description = 'Generate a starmoozie templated view';
