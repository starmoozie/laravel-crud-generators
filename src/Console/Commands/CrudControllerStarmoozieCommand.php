...
class CrudControllerStarmoozieCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'starmoozie:crud-controller';
     ...
     * @var string
     */
    protected $signature = 'starmoozie:crud-controller {name}';
     ...
     * @var string
     */
    protected $description = 'Generate a Starmoozie CRUD controller';
