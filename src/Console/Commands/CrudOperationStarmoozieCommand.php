...
class CrudOperationStarmoozieCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'starmoozie:crud-operation';
     ...
     * @var string
     */
    protected $signature = 'starmoozie:crud-operation {name}';
     ...
     * @var string
     */
    protected $description = 'Generate a Starmoozie CRUD operation trait';
