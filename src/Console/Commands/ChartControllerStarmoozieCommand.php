...
class ChartControllerStarmoozieCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'starmoozie:chart-controller';
     ...
     * @var string
     */
    protected $signature = 'starmoozie:chart-controller {name}';
     ...
     * @var string
     */
    protected $description = 'Generate a Starmoozie ChartController';
